...
(function() {
  $(document).on('page:change', function() {
    return $('#comments-link').click(function(e) {
      e.preventDefault();
      $('#coments-section').fadeToggle('slow');
      return $('#comment_description').focus();
    });
  });
...
(function() {
  $(document).on('page:change', function() {
    return $('div#conference_show_speeches').on('click', function() {
      ...
      $('#abc').fadeToggle('slow');
      return $('#paginator').fadeToggle('slow');
    });
  });
...
(function() {
  $(document).on('page:change', function() {
    ...
    return $('img#close').click(function() {
...
(function() {
  $(document).on('ready page:load', function() {
    return $('.delete_my_speech').on('click', function() {
      var current_item_row;
      ...
      if (confirm('Do you really want to destroy this speech?')) {
        return $.ajax({
          ...
          success: function(result) {
            return $(current_item_row).fadeOut('slow');
          }
        });
      }
    });
